...
/**
 * note: this class implements RoundImageView which-
 * -could be used as a utility
 * note: this class is a subclass of ImageView
 * when used, only width and height should be appointed
 * and border color can be served as an optimal customization
 */
...
public class RoundImageView extends ImageView {
    ...
    /**
     *  note: get the round image cropped
     * @param bmp :: src image bitmap (rectangular)
     * @param radius :: circle radius
     * @return :: dest image bitmap (round)
     */
    ...
    private void  drawCircleBorder(Canvas canvas, int radius, int color) {
        ...
        //smooth the edge/border
        paint.setAntiAlias(true);
        paint.setFilterBitmap(true);
        paint.setDither(true);
        paint.setColor(color);

        //empty content of the paint
