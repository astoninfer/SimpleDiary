...
import com.example.jeylnastoninfer.debug7.FlowLayout;
...
public class PopMenu_AddTag extends PopupWindow {
    ...
    RecordFileInfo recordFile;
    int i = 0;
    public PopMenu_AddTag(final Activity context, final RecordFileInfo recordFile) {
        super(context);
